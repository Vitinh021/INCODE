...
import './ProgressoDeNivel4.css'; // Certifique-se de que o caminho está correto
import { FaRegUserCircle } from 'react-icons/fa';
import { FaHouse } from "react-icons/fa6";
import { GoArrowLeft } from "react-icons/go";

const ProgressoDeNivel4 = () => {
  ...
  const niveis = [
    ...
    { id: 1, src: "/imagens/15.png", alt: 'Cenário do nível 1' },
    { id: 2, src: '/imagens/15.png', alt: 'Cenário do nível 2' },
    { id: 3, src: '/imagens/15.png', alt: 'Cenário do nível 3' },
    { id: 4, src: '/imagens/15.png', alt: 'Cenário do nível 4' },
    { id: 5, src: '/imagens/15.png', alt: 'Cenário do nível 5' },
  ];
...
export default ProgressoDeNivel4;
